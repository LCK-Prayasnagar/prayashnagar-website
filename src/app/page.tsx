  ...
  return (
    <>
      <div className="min-h-screen flex flex-col lg:flex-row bg-[#F5E9D4] relative">
        {/* Left Section */}
        <div
  className=" sm:w-[55.56%] w-full bg-[#12184F] text-white justify-start p-8"
...
>          {/* Logo */}
          ...
          {/* Text Content */}
          <p className="text-lg md:text-xl text-start max-w-md mb-6 pe-25">
            Leo Club of Kathmandu Prayasnagar, founded on January 13, 2020, is a
            youth-led organization committed to leadership, community, impact. As
            part of Leo
          </p>
          ...
          <div className="flex align-bottom gap-14 mt-25">
        ...
        {/* Right Section */}
        <div className="sm:w-[44.44%] w-full flex flex-col justify-center items-center">
          <div className="w-full h-full">
            <div className="" style={{ marginTop: '-80px' }}>
              <img src="./peoplesvg.png" alt="" />
            </div>
            {/* Main Heading */}
            <h1 className="text-[60px] font-bold text-blue-900 text-start mb-4 Ab w-full gradient-text z-5 relative" style={{ marginLeft: '-210px' }}>
              Leo Club of Kathmandu <br /> Prayasnagar
            </h1>

            {/* Tagline */}
            <p className="text-[25px] text-blue-900 text-center mb-6 z-5 relative" style={{ marginLeft: '-710px' }}>
              Hands to Serve, Hearts to Love.
            </p>

            {/* Social Media Icons */}
            <div className="flex gap-4 justify-end pe-20">
