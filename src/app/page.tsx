  ...
  return (
    <>
      ...
      <div className="bg-[#F5E9D4] relative hidden lg:block">
        <div
          className="min-w-[100vw;] lg:h-[790px] bg-[#12184F]"
          style={{ clipPath: 'polygon(0% 0%, 47% 0%, 66% 100%, 0% 100%)' }}
        />
        <div className="absolute top-0 flex w-full flex-col lg:flex-row">
          {/* Left Section */}
          ...
          <div className="sm:w-[44.44%] md:w-auto flex flex-col justify-center items-center">
            <div className="w-full h-full">
              ...
              {/* Main Heading */}
              <h1 className="lg:text-5xl xl:text-6xl font-bold mb-4 w-full gradient-text z-5">
      ...
      <div className="bg-[#F5E9D4] relative lg:hidden">
        ...
        <div className="absolute top-0 w-full">
          ...
          <div className="mx-5">
            ...
            <div className="pt-5 flex justify-between gap-26">
              {/* Social Media Icons */}
