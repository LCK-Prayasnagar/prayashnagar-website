      ...
      <div className="max-w-xl text-center md:text-left">
        ...
        <div>
          ...
          <p className="text-white text-base leading-relaxed">
            ...
            to create a space where youth can come together, learn, lead, and serve with purpose.
            Our club is built on the foundation of empowerment, growth, and the collective desire to
            make a positive impact on causes that matter most in education, health, digital
            literacy, and environmental sustainability. At Leo Club of Kathmandu Prayasnagar, we are
            more than just an organization, we are like a family. We support each other, grow
            together, and work in harmony to achieve our common goals. It’s this sense of belonging
            and unity that drives us to create meaningful change in our communities. We believe that
            through collaboration and shared values, we can achieve great things and empower the
            next generation of leaders. I invite you to join our family, where you will discover not
            just a chance for personal growth but also the opportunity to contribute to something
            greater than yourself. Together, we can inspire change, promote leadership, and build a
            better future for all. Let’s lead with passion, serve with purpose, grow as one and
            crown the vision.
          </p>
        </div>
      </div>
